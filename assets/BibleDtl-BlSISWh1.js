import{j as r}from"./index-Ck2d_L_e.js";import{r as s,u as d,R as p}from"./router-BlMcuVHC.js";import{o as u,H as k}from"./App--a2e3x7R.js";import{T as B}from"./TitleItem-C1NNEoRP.js";import{u as T,B as f}from"./BibleBookmarkText-CRYzu5-p.js";import"./vendor-CCYiWZgt.js";const j=t=>{const e=t.dataText;return r.jsx("div",{className:"grid grid-cols-5 sm:grid-cols-6 md:grid-cols-10 lg:grid-cols-12 gap-4",id:"id_1",children:r.jsx("div",{className:"col-span-4 sm:col-span-5 md:col-span-9 lg:col-span-11",children:r.jsx("div",{className:"text-gray-900 dark:text-white",children:r.jsx(k,{text:e?.text})})})},"id_1")},N=()=>{const[t,e]=s.useState(null),a={nm:"주기도문",text:`<br>하늘에 계신 우리 아버지여,<br>
