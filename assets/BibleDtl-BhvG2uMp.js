import{r as s,a as m,k as u,j as e,R as p,H as k}from"./index-DRYhf1EU.js";import{T as B}from"./TitleItem-DX22YVx5.js";import{u as T,B as j}from"./BibleBookmarkText-Bhg2WWbp.js";const g=t=>{const r=t.dataText;return e.jsx("div",{className:"grid grid-cols-5 sm:grid-cols-6 md:grid-cols-10 lg:grid-cols-12 gap-4",id:"id_1",children:e.jsx("div",{className:"col-span-4 sm:col-span-5 md:col-span-9 lg:col-span-11",children:e.jsx("div",{className:"text-gray-900 dark:text-white",children:e.jsx(k,{text:r?.text})})})},"id_1")},y=()=>{const[t,r]=s.useState(null),o={nm:"주기도문",text:`<br>하늘에 계신 우리 아버지여,<br>
