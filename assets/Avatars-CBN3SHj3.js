import{j as s,d6 as t,S as i,d8 as a,dc as r,dd as e,de as l}from"./index-DSTFP3D0.js";import{P as u}from"./PageBreadCrumb-BUKcJBCL.js";import{T as m}from"./TailHomeButton-B6U-UXvP.js";import"./TailButton-ti9wy14p.js";function v(){return s.jsxs(s.Fragment,{children:[s.jsx(t,{title:`${i.appTitle} - Tailwind Avatars`,description:"This is React.js Avatars Dashboard page for TailAdmin - React.js Tailwind CSS Admin Dashboard Template"}),s.jsx(m,{}),s.jsx(u,{pageTitle:"Avatars"}),s.jsx(a,{title:"Avatar Component (Avatar.js)",children:s.jsx(r,{postData:`const sizeClasses = {
...
</ComponentCard>`})]})]})}export{v as default};
